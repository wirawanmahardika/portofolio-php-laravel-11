<x-layout>
    ...
    <main class="bg-bgBlack min-h-screen py-10 text-white px-5 xl:px-20 w-full">
        ...
        <div class="w-full grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-3">
            ...
            @foreach ($apis as $a)
                <div
                    class="project || flex flex-col gap-y-2 border-2 border-red-800 bg-white text-black rounded px-2 py-3">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-14 mt-10">
            ...
            @foreach ($projects as $p)
                <div class="project || border-2 border-slate-500 rounded bg-white">
    ...
    <script src="/js/animation/project.js"></script>
</x-layout>
